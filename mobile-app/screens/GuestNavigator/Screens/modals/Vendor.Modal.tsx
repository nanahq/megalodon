...
import {GuestAppScreenName, ModalScreenName} from "@screens/GuestNavigator/ScreenName.enum";
import {GuestAppParamList} from "@screens/GuestNavigator/AppNav";
...
type VendorModalScreenProps = StackScreenProps<GuestAppParamList, ModalScreenName.MODAL_VENDOR_SCREEN>
    ...
    useEffect(() => {
        ...
        useEffect(() => {
            navigation.setOptions({
                ...
                headerLeft: () => <ModalCloseIcon onPress={() => navigation.navigate<any>(HomeScreenName.HOME)} />,
            })
        }, [])
     ...
     const goToBasket = () => {
         setTimeout(() => {
             navigation.navigate<any>(GuestAppScreenName.BASKET, {
