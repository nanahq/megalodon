...
export function AppToast (props: AppToastProps): JSX.Element {
    return  (
        <View style={tailwind('py-4 w-3/4 px-4 mt-16 rounded-lg flex items-center justify-center', {
           ...
           <IconComponent iconType='Feather' name={ props.type === 'success' ? 'check-circle' : 'alert-circle'} style={tailwind('text-white font-bold ml-2')}  size={12} />
           </View>
        </View>
    )
}
